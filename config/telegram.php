...
return [
    ...
    |
    */
    'bot_token' => env('TELEGRAM_BOT_TOKEN', '344822354:AAFqc7bxHRAiP--wV7u2a-aCWVT026ceiUM'),
...
//        App\Commands\FcCommand::class,
//        App\Commands\PokeCommand::class,
    ],
];
